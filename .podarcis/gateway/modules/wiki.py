...
TOOLS = ['wiki_search', 'wiki_get', 'wiki_multi_get', 'wiki_update_index', 'complete_source_synthesis', 'lint_check_links', 'sync_workspaces', 'get_workspace_status']
...
def register(mcp, root: Path) -> None:
    ...
    mcp.add_tool(wiki_server.get_workspace_status)
